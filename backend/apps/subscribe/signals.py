        ...
        if hasattr(instance,'_previous_status'):
            if instance._previous_status != instance.status:
                SubscriptionHistory.objects.create(
                    ...
                    description =f'Subscription changed from instance{instance._previous_status} to {instance.status}'
                )
...
def pinned_post_pre_delete(sender,instance,created,**kwargs):
